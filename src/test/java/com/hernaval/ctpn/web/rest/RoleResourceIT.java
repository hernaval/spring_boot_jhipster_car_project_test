...
import com.hernaval.ctpn.service.mapper.RoleMapper;
...
class RoleResourceIT {
    ...
    private static final ERole DEFAULT_NAME = ERole.ROLE_ADMIN;
    private static final ERole UPDATED_NAME = ERole.ROLE_USER;
