...
import com.hernaval.ctpn.service.mapper.CarMapper;
...
class CarResourceIT {
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().mark(DEFAULT_MARK).description(DEFAULT_DESCRIPTION);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().mark(UPDATED_MARK).description(UPDATED_DESCRIPTION);
        return car;
    }
    ...
    void createCar() throws Exception {
        ...
        assertThat(testCar.getMark()).isEqualTo(DEFAULT_MARK);
    ...
    void putNewCar() throws Exception {
        ...
        updatedCar.mark(UPDATED_MARK).description(UPDATED_DESCRIPTION);
        ...
        Car testCar = carList.get(carList.size() - 1);
        assertThat(testCar.getMark()).isEqualTo(UPDATED_MARK);
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.mark(UPDATED_MARK).description(UPDATED_DESCRIPTION);
