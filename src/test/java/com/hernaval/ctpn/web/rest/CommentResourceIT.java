...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().message(DEFAULT_MESSAGE).publishDate(DEFAULT_PUBLISH_DATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().message(UPDATED_MESSAGE).publishDate(UPDATED_PUBLISH_DATE);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.message(UPDATED_MESSAGE).publishDate(UPDATED_PUBLISH_DATE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.message(UPDATED_MESSAGE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.message(UPDATED_MESSAGE).publishDate(UPDATED_PUBLISH_DATE);
